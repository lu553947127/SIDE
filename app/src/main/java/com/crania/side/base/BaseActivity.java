...
import com.crania.side.utils.AutoUtils;
 ...
 * @Author: 鹿鸿祥
 * @CreateDate: 2022/2/7 10:06
 * @UpdateUser: 更新者
 * @UpdateDate: 2022/2/7 10:06
 * @UpdateRemark: 更新说明
 * @Version: 1.0
 */
public abstract class BaseActivity extends AppCompatActivity implements IView, BGASwipeBackHelper.Delegate,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (!isTranslationBar) {
            //默认false为白色状态栏
            BarUtils.setStatusBarColor(this, ContextCompat.getColor(Utils.getApp(), R.color.white), false);
